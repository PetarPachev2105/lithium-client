...
class LithiumHood extends Component {
  ...
  async componentDidMount() {
    this.virtualLithiumHood = new VirtualLithiumHood(
      this.token,
      this.clientId,
      this.lithiumHoodId
    );
  ...
  createGroupLithiumRoom = () => {
    this.virtualLithiumHood.creatingGroupLithiumRoom(
      this.state.newLithiumRoomName
    );
  ...
  toggleLithiumHoodMembersDrawer = () => {
    this.setState({
      isLithiumHoodMembersDrawerOpened:
        !this.state.isLithiumHoodMembersDrawerOpened,
    });
  };
  ...
  updateLastMessage = (updatedLithiumRoom, message) => {
    const lithiumRooms = this.state.lithiumRooms;
    const changedLithiumRoom = lithiumRooms.find(
      (lithiumRoom) => lithiumRoom.id === updatedLithiumRoom.id
    );
  ...
  render() {
    return (
      <div className={styles.home}>
        ...
        {this.state.isInitialLoadingDone && this.state.user && (
          <div>
            <nav className={styles.navbar}>
              <div className={styles.trapezoid}>
                <div className={styles.subnav}>
                  <button
                    onClick={this.toggleAccountDrawer}
                ...
                <div className={styles.subnav}>
                  <button
                    onClick={this.toggleLithiumHoodMembersDrawer}
                    className={styles.subnavbtn}
                  >
                    Crew
                  </button>
            ...
            {this.state.lithiumRooms.length < 1 && (
              <div className={styles.noLithiumRooms}>
            ...
            <main className={styles.main}>
              {this.state.lithiumRooms.length >= 1 && (
                <div className={styles.lithiumRoomsContainer}>
                  {this.state.lithiumRooms.map((chatRoom) => (
                    ...
                    >
                      <div className={styles.lithiumRoomName}>
                        {chatRoom.name}
                      </div>
              ...
              >
                <div className={Classes.DRAWER_BODY}>
                  <div className={Classes.DIALOG_BODY}>
                    <LithiumHoodMembers
                      virtualLithiumHood={this.virtualLithiumHood}
                    />
                  </div>
                </div>
              </Drawer>
              ...
              >
                <div className={Classes.DIALOG_BODY}>
                  <FormGroup>
                    ...
                    <button
                      onClick={this.createGroupLithiumRoom}
